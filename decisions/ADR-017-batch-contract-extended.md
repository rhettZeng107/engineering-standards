...
> **2026-09-07修订**：每仓按已验收业务批次合并代码、测试及文档提交，不按单文件、Phase或每份文档即时推送；独立文档任务可成批。保留总体覆盖、他人脏改、pull/rebase及配置远端核验；最终hash存外部回执，不递归生成收尾提交。完整执行/试行口径见[ADR-039](./ADR-039-standard-task-workflow.md)。
