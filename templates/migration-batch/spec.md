...
- `codex-migration-audit completeness` proves all required sweep dimensions completed with evidence, all discovered gaps resolved, and the final two critic rounds consecutively dry.
